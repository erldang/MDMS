<template>
  <div>
    ...
    <div class="flex-container">
      ...
      <!-- 차트를 표시할 div 요소 -->
      <div v-show="showTableList || showTerminologyList" class="flex-item chart-section" ref="chartdiv"></div>
    </div>
  </div>
</template>
...
.toggle-btn {
  ...
  border: none;
  color: white;
  background-color:  #27ae60; /* 밝은 파란색 */
  cursor: pointer;
  border-radius: 5px;
...
/* 반응형 스타일: 모바일 화면에서 버튼을 전체 너비로 확장 */
